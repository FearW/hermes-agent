...
MEMORY_SCHEMA = {
    "name": "memory",
    "description": (
        "Save durable info that survives sessions. Injected into future turns — keep compact and factual.\n\n"
        "Save proactively when: user corrects you, shares a preference/habit/personal detail, you learn "
        "an env/tool/project convention, or identify a stable fact useful in future sessions.\n\n"
        "PRIORITY: user preferences > env facts > procedural knowledge.\n\n"
        "Targets:\n"
