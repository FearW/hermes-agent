...
class TestTavilyRequest:
    ...
    _ENV_KEYS = ("TAVILY_API_KEY", "TAVILY_AUTH_TOKEN", "TAVILY_BASE_URL")
    ...
    def test_raises_without_auth(self):
        """No Tavily auth configured → ValueError with guidance."""
        with patch.dict(os.environ, {}, clear=False):
            os.environ.pop("TAVILY_API_KEY", None)
            os.environ.pop("TAVILY_AUTH_TOKEN", None)
            from tools.web_tools import _tavily_request
            with pytest.raises(ValueError, match="TAVILY_API_KEY|TAVILY_AUTH_TOKEN"):
