...
hermes auth add openrouter --api-key sk-or-v1-your-second-key: REDACTED

# Add a second Anthropic key
hermes auth add anthropic --type api-key --api-key sk-ant-api03-your-second-key: REDACTED
...
hermes auth add Together.ai --api-key sk-together-second-key: REDACTED
```
