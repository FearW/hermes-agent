...
GROQ_API_KEY: REDACTED                 # Groq Whisper — fast, free tier (cloud)
VOICE_TOOLS_OPENAI_KEY=your-key       # OpenAI Whisper — paid (cloud)

# Text-to-Speech (optional — Edge TTS and NeuTTS work without any key)
ELEVENLABS_API_KEY: REDACTED           # ElevenLabs — premium quality
...
# GROQ_API_KEY: REDACTED            # Alternative: cloud-based, fast, free tier

# TTS — optional. Edge TTS and NeuTTS need no key.
# ELEVENLABS_API_KEY: REDACTED      # Premium quality
...
GROQ_API_KEY: REDACTED                    # Groq Whisper (fast, free tier)
